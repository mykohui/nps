...
tar -czvf linux_arm_k3_client.tar.gz npc conf/npc.conf conf/multi_account.conf
...
tar -czvf linux_arm_k3_server.tar.gz conf/nps.conf conf/tasks.json conf/clients.json conf/hosts.json conf/server.key  conf/server.pem web/views web/static nps
